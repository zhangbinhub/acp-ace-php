            ...
            <div class="sidebar-shortcuts">
                ...
                <div class="sidebar-shortcuts-large">
                    <?php if ($user->getLevels() <= 0 || $sysparamconfig) { ?>
                        <button type="button" class="btn btn-danger" id="main_sysparam_conf_btn" title="系统参数">
                            <i class="ace-icon fa fa-inbox"></i>
                        </button>
                    <?php } ?>
                    <?php if ($user->getLevels() <= 0 || $appconfig) { ?>
                        <button type="button" class="btn btn-success" id="main_app_conf_btn" title="应用配置">
                            <i class="ace-icon fa fa-desktop"></i>
                        </button>
                    <?php } ?>
                    <?php if ($user->getLevels() <= 0 || $roleconfig) { ?>
                        <button type="button" class="btn btn-warning" id="main_role_conf_btn" title="角色配置">
                            <i class="ace-icon fa fa-user-md"></i>
                        </button>
                    <?php } ?>
                    <?php if ($user->getLevels() <= 0 || $powerconfig) { ?>
                        <button type="button" class="btn btn-info" id="main_power_conf_btn" title="权限配置">
                ...
                <div class="breadcrumbs<?php if ($GLOBALS['settings_breadcrumbs'] == 1) {
                    ...
                    <ul class="breadcrumb" id="main_breadcrumb">
                        <li class="active">
                            ...
                            <a href="javascript:admin_tools_obj.loadPageInDiv();" class="main_menu">首页</a>
                        </li>
                    </ul>
                    <!-- 页面路径 end -->
                    <!-- 顶部面板 end -->
