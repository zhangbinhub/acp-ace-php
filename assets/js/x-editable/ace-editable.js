    ...
    $.extend(Image.prototype, {
        ...
        **/
        render: function() {
			...
			var spanWidth = '150px';
			if (self.options.image.thumbnail == 'fit') {
				spanWidth = $('#' + this.options.image.name).parent().width() + 'px';
			}
			...
			}).closest('.ace-file-input').css({'width':spanWidth}).closest('.editable-input').addClass('editable-image');
